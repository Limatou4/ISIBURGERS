...
<body>
    ...
    <form method="GET" action="{{ route('filtrer.burgers') }}" style="margin-bottom: 20px;">
        <label for="libelle">Filtrer par Libellé :</label>
        <input type="text" name="libelle" id="libelle" placeholder="Nom du burger" value="{{ request('libelle') }}">

        <label for="prix_min">Prix Min :</label>
        <input type="number" name="prix_min" id="prix_min" placeholder="Prix minimum" value="{{ request('prix_min') }}">

        <label for="prix_max">Prix Max :</label>
        <input type="number" name="prix_max" id="prix_max" placeholder="Prix maximum" value="{{ request('prix_max') }}">
    ...
    <div class="row">
        ...
        <div class="burger-card">
            ...
            <p class="price">{{ number_format($burger->prix, 2) }}F</p>
            <form action="{{ route('ajouter-au-panier') }}" method="POST">
                @csrf

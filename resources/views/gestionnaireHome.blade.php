...
<button class="logout-btn" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Déconnexion</button>
    ...
    <div class="content">
        ...
        <a href="{{ route('burgers.home') }}">Gestion des Burgers</a>
        <a href="{{ route('commandegestion') }}">Gestion des Commandes</a>
        <a href="{{ route('paiement.home') }}">Gestion des Paiements</a>
        <a href="{{ route('statistique.home') }}">Statistiques et Rapports</a>
<a href="{{ route('notification.home') }}">Notifications</a>
<a href="{{ route('profil.home') }}">Voir mon profil</a>
        </div>
    </div>

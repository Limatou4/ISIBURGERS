                ...
                <tbody>
                    @foreach($commandes as $commande)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('commandedetailgest', $commande->id) }}" class="btn-edit">Voir</a>
                                <a href="" class="btn-delete">Annuler</a>
                                <a href="{{ route('modifiercommande', $commande->id) }}" class="btn-delete">Modifier</a>

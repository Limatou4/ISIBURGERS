...
<body>
    ...
    <div class="menu-section">
        ...
        <table class="panier-table">
            <thead>
                <tr>
                    ...
                    <th>Prix Unitaire</th>
                    <th>Total</th>
                    <th>Action</th> <!-- Ajout de la colonne Action pour le bouton Retirer -->
                </tr>
            </thead>
            <tbody>
                @foreach ($panierItems as $item)
                    <tr>
                        <td>{{ $item->burger->nom }}</td> <!-- Afficher le nom du burger -->
                        <td>{{ $item->quantite }}</td> <!-- Afficher la quantité -->
                        <td>{{ number_format($item->prix_total / $item->quantite, 2) }} F</td> <!-- Prix unitaire -->
                        <td>{{ number_format($item->prix_total, 2) }} F</td> <!-- Prix total -->
                        <td>
                            <!-- Bouton de suppression pour retirer l'élément du panier -->
        ...
        <a href="{{ route('commande.home') }}" class="btn-validation">Valider mon panier</a>
